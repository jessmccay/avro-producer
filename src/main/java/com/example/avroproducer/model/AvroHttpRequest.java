 ...
 */
package com.example.avroproducer.model;
...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 473624111148097250L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroHttpRequest\",\"namespace\":\"com.example.avroproducer.model\",\"fields\":[{\"name\":\"requestTime\",\"type\":\"long\"},{\"name\":\"clientIdentifier\",\"type\":{\"type\":\"record\",\"name\":\"ClientIdentifier\",\"fields\":[{\"name\":\"hostName\",\"type\":\"string\"},{\"name\":\"ipAddress\",\"type\":\"string\"}]}},{\"name\":\"employeeNames\",\"type\":{\"type\":\"array\",\"items\":\"string\"},\"default\":null}]}");
  ...
  @Deprecated public com.example.avroproducer.model.ClientIdentifier clientIdentifier;
   ...
   */
  public AvroHttpRequest(java.lang.Long requestTime, com.example.avroproducer.model.ClientIdentifier clientIdentifier, java.util.List<java.lang.CharSequence> employeeNames) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: clientIdentifier = (com.example.avroproducer.model.ClientIdentifier)value$; break;
   ...
   */
  public com.example.avroproducer.model.ClientIdentifier getClientIdentifier() {
   ...
   * @param value the value to set.
   */
  public void setClientIdentifier(com.example.avroproducer.model.ClientIdentifier value) {
   ...
   */
  public static com.example.avroproducer.model.AvroHttpRequest.Builder newBuilder() {
    return new com.example.avroproducer.model.AvroHttpRequest.Builder();
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.example.avroproducer.model.AvroHttpRequest.Builder newBuilder(com.example.avroproducer.model.AvroHttpRequest.Builder other) {
    return new com.example.avroproducer.model.AvroHttpRequest.Builder(other);
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.example.avroproducer.model.AvroHttpRequest.Builder newBuilder(com.example.avroproducer.model.AvroHttpRequest other) {
    return new com.example.avroproducer.model.AvroHttpRequest.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
    ...
    private com.example.avroproducer.model.ClientIdentifier clientIdentifier;
    private com.example.avroproducer.model.ClientIdentifier.Builder clientIdentifierBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.avroproducer.model.AvroHttpRequest.Builder other) {
      super(other);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = com.example.avroproducer.model.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.avroproducer.model.AvroHttpRequest other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTime)) {
        this.requestTime = data().deepCopy(fields()[0].schema(), other.requestTime);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avroproducer.model.AvroHttpRequest.Builder setRequestTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avroproducer.model.AvroHttpRequest.Builder clearRequestTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avroproducer.model.AvroHttpRequest.Builder setClientIdentifier(com.example.avroproducer.model.ClientIdentifier value) {
     ...
     * @return This builder.
     */
    public com.example.avroproducer.model.ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(com.example.avroproducer.model.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(com.example.avroproducer.model.ClientIdentifier.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.example.avroproducer.model.AvroHttpRequest.Builder setClientIdentifierBuilder(com.example.avroproducer.model.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avroproducer.model.AvroHttpRequest.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avroproducer.model.AvroHttpRequest.Builder setEmployeeNames(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avroproducer.model.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
    ...
    public AvroHttpRequest build() {
      try {
        ...
        if (clientIdentifierBuilder != null) {
          ...
          record.clientIdentifier = fieldSetFlags()[1] ? this.clientIdentifier : (com.example.avroproducer.model.ClientIdentifier) defaultValue(fields()[1]);
        }
