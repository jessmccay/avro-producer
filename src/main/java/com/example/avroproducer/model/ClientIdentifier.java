...
public class ClientIdentifier extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2034613534549349286L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ClientIdentifier\",\"namespace\":\"com.example.avroproducer.model\",\"fields\":[{\"name\":\"hostName\",\"type\":\"string\"},{\"name\":\"ipAddress\",\"type\":\"string\"}]}");
   ...
   */
  public static com.example.avroproducer.model.ClientIdentifier.Builder newBuilder() {
    return new com.example.avroproducer.model.ClientIdentifier.Builder();
  }
   ...
   * @return A new ClientIdentifier RecordBuilder
   */
  public static com.example.avroproducer.model.ClientIdentifier.Builder newBuilder(com.example.avroproducer.model.ClientIdentifier.Builder other) {
    return new com.example.avroproducer.model.ClientIdentifier.Builder(other);
  }
   ...
   * @return A new ClientIdentifier RecordBuilder
   */
  public static com.example.avroproducer.model.ClientIdentifier.Builder newBuilder(com.example.avroproducer.model.ClientIdentifier other) {
    return new com.example.avroproducer.model.ClientIdentifier.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ClientIdentifier>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.avroproducer.model.ClientIdentifier.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.avroproducer.model.ClientIdentifier other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.hostName)) {
        this.hostName = data().deepCopy(fields()[0].schema(), other.hostName);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avroproducer.model.ClientIdentifier.Builder setHostName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avroproducer.model.ClientIdentifier.Builder clearHostName() {
      hostName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avroproducer.model.ClientIdentifier.Builder setIpAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avroproducer.model.ClientIdentifier.Builder clearIpAddress() {
      ipAddress = null;
